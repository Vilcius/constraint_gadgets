...
def main():
    ...
    default_name = (args.profile+'-b-five-methods' if args.study == 'b' else
                    'smoke-five-methods' if args.profile == 'smoke' else args.profile)
    output = (args.output or ROOT/'tuning/results'/default_name).resolve()
