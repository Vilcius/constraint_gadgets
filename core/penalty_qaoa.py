"""
penalty_qaoa.py -- Penalty-based QAOA with JAX-jitted optimisation.

All constraints are encoded as penalty terms in the Hamiltonian.
The cost circuit and Adam optimisation step are JIT-compiled via JAX.
...
class PenaltyQAOA:
    """
    Penalty-based QAOA: all constraints encoded as Hamiltonian penalty terms.
    """
    ...
    def do_counts_circuit(self, angles=None, shots: int = 1000) -> dict:
        ...
        Sample bitstrings using lightning.qubit.
        """
